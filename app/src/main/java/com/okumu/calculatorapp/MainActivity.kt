package com.okumu.calculatorapp
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (buttonId in buttonIds) {
            ...
            if (buttonId in arrayOf(R.id.buttonDot, R.id.button0, R.id.button1, R.id.button2, R.id.button3, R.id.button4, R.id.button5, R.id.button6, R.id.button7, R.id.button8, R.id.button9)) {
                ...
                drawable?.setTint(color)  // Use setTint instead of setColorFilter
            ...
            if (buttonId in arrayOf(R.id.backspace, R.id.AC)) {
                val color = ContextCompat.getColor(this, R.color.red)
                // Get the drawable for the button background and allow it to be modified
                val drawable = ContextCompat.getDrawable(this, R.drawable.rounded_button)?.mutate()
                // Change the color of the button background to the special button color
                drawable?.setTint(color)  // Use setTint instead of the deprecated setColorFilter
